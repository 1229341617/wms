			...
			<div id="login_box">
				<div id="login_form">
					<s:form id="submitForm" namespace="/" action="login" method="post">
						...
						<div>
							 用户名：<input type="text" name="username" class="username" id="name" value="">
						</div>
						<div>
							密&nbsp;&nbsp;&nbsp;&nbsp;码：<input type="password" name="password" class="pwd" id="pwd" value="">
						</div>
						<div id="btn_area">
							<input type="button" class="login_btn" id="login_sub"  value="登录">
