...
<body>
	...
	<s:form name="editForm" action="department_saveOrUpdate" method="post" id="editForm">
		<s:hidden name="department.id" />
		<div id="container">
			<div id="nav_links">
				<span style="color: #1A5CC6;">专业编辑</span>
				<div id="page_close">
					<a>
			...
			<div class="ui_content">
				<table cellspacing="0" cellpadding="0" width="100%" align="left" border="0">
					<tr>
						<td class="ui_text_rt" width="140">专业名称</td>
						<td class="ui_text_lt">
							<s:textfield name="department.name" cssClass="ui_input_txt02" />
						</td>
					</tr>
					<tr>
						<td class="ui_text_rt" width="140">专业编码</td>
						<td class="ui_text_lt">
