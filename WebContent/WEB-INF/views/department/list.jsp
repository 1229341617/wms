...
<body>
	...
	<s:form namespace="/" id="searchForm" action="department" method="post">
		<div id="container">
					...
					<table class="table" cellspacing="0" cellpadding="0" width="100%" align="center" border="0">
						...
						<s:iterator value="#pageResult.result">
							<tr>
								...
								<td>
									<s:url var="empEdit" namespace="/" action="department_input">
										<s:param name="department.id" value="id"/>
									</s:url>
									<a href="<s:property value="empEdit"/>">编辑</a>
									<s:url var="empDelete" namespace="/" action="department_delete">
										<s:param name="department.id" value="id"/>
									</s:url>
