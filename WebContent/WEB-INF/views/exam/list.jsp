...
<body>
	...
	<s:form namespace="/" id="searchForm" action="exam" method="post">
		<div id="container">
			<div class="ui_content">
				<div class="ui_text_indent">
					<div id="box_border">
						...
						<div id="box_bottom">
							<input type="button" value="新增" class="ui_input_btn01 btn_redirect" data-url="<s:url namespace="/" action="exam_input"/>"/> 
						</div>
					</div>
				</div>
			</div>
					...
					<table class="table" cellspacing="0" cellpadding="0" width="100%" align="center" border="0">
						...
						<s:iterator value="#pageResult.result">
							<tr>
								...
								<td><s:property value="totaltimes"/></td>
								...
								<td>
									<s:url var="edit" namespace="/" action="exam_input">
										<s:param name="exam.id" value="id"/>
									</s:url>
									<a href="<s:property value="edit"/>">编辑</a>
									<s:url var="delete" namespace="/" action="exam_delete">
										<s:param name="exam.id" value="id"/>
									</s:url>
