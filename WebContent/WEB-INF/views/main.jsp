			...
			<div id="top_op">
				<ul>
					<li>
						...
						<span><s:property value="#session.username_in_session" /></span>
					</li>
					<li>
	...
	<div id="side">
		<div id="left_menu">
		 	<ul id="TabPage2" style="height:200px; margin-top:50px;">
				<li id="left_tab1" class="selected"  title="系统中心" data-rootmenu="system">
					<img alt="系统中心" title="系统中心" src="images/common/1.jpg" width="33" height="31">
				</li>		
				<li id="left_tab2" title="业务中心" data-rootmenu="business">
					<img alt="业务中心" title="业务中心" src="images/common/2.jpg" width="33" height="31">
				</li>
				<li id="left_tab3" title="查询中心" data-rootmenu="show">
					<img alt="查询中心" title="查询中心" src="images/common/3.jpg" width="33" height="31">
				</li>
			</ul>
