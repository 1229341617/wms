					...
					<tr>
						...
						<td class="ui_text_lt">
							<table>
								<tr>
									<td>
										<s:select name="" list="#permissions" multiple="true" listKey="id" listValue="name" cssClass="ui_multiselect01 left"/>
									</td>
									<td align="center">
									...
									<td>
										<s:select name="role.permissions.id" list="role.permissions" multiple="true" listKey="id" listValue="name" cssClass="ui_multiselect01 right"/>
									</td>
								</tr>
							</table>
						</td>
					...
					<tr>
						...
						<td class="ui_text_lt">
							<table>
								<tr>
									<td>
										<s:select name="" list="#menus" multiple="true" listKey="id" listValue="name" cssClass="ui_multiselect01 mleft"/>
									</td>
									<td align="center">
									...
									<td>
										<s:select name="role.menus.id" list="role.menus" multiple="true" listKey="id" listValue="name" cssClass="ui_multiselect01 mright"/>
									</td>
								</tr>
							</table>
						</td>
